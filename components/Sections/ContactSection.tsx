        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-2xl p-8">
              ...
              {/* Personal Details */}
              <h4 className="text-lg font-bold text-gray-900 mb-4">Personal Details</h4>
          ...
          >
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Personal Interests</h3>
            ...
            {/* References */}
            <div className="bg-gray-50 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Professional References</h3>
              <div className="space-y-4 max-h-96 overflow-y-auto">
                {references.map((ref, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-xs mt-1">{ref.contact}</p>
