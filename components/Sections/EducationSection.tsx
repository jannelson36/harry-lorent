            ...
            {[
              {
                ...
                description: "Excel in research and develop innovative practices for knowledge sharing"
              },
              {
                title: "Economic Impact",
                description: "Contribute to elevating the local and global economy through dedicated work"
              },
              {
                title: "Continuous Growth",
                description: "Continually improve skills for competitiveness in the job market"
              }
            ].map((ambition, index) => (
              <motion.div
                key={ambition.title}
